  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        toolbarHeight: 30,
        backgroundColor: Color.fromARGB(255, 255, 137, 202),
        elevation: 0,
        actions: [
          Padding(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                color: const Color.fromARGB(255, 255, 137, 202),
                borderRadius:
          ...
          Padding(
            ...
            child: Column(
              children: [
                inputForm("ราคารถ", _controller1, "เช่น 600,000"),
                inputForm("เงินดาวน์", _controller2, "เช่น 100,000"),
